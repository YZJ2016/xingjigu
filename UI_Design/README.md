...
- 系统设置第五轮业务闭环：人员账号、人员资质、角色权限、审批设置、接口补偿配置、消息提醒、操作记录、数据备份已接入统一 `MES_BUSINESS_FLOW.governanceEvents`，新增跨流程治理看板，支持权限复核、发布/启用、停用/锁定、补偿申请、稽核样本、恢复演练等治理动作写入统一业务事实
