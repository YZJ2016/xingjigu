...
const pageDefinitions = {
  ...
  final: {
    ...
    tableHint: "FQC 以生产履历、检验项和质量角色电子签名为准入依据，合格后允许成品标签和入库衔接",
    ...
    primaryMessage: "模拟 FQC 合格并由质量角色签核，已放行成品标签和入库准入",
  ...
  release: {
    ...
    tableHint: "后台只负责质量角色签核、拦截处置和追溯留痕，不替代现场 FQC、包装扫码或库存入库动作",
    cardTitle: "FQC、NCR/MRB、标签和入库准入闭环",
    simulationTitle: "模拟 FQC / WMS / 标签系统放行回执",
    simulationHint: "模拟外部 FQC 检验台、WMS 冻结状态、MES 库存状态或标签系统回传，页面只登记质量角色签核、拦截和追溯引用",
    primaryStatus: "质量已放行",
