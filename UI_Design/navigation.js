const MES_NAV_MODULES = [
  ...
  { id: "dispatch", title: "派工与生产任务", layer: "车间管理", color: "#34c759", mark: "任", items: ["派工单", "工序任务", "班组任务", "任务下达", "任务变更", "工艺文件与作业指导", "开工检查"] },
  { id: "station", title: "工位作业", layer: "现场终端", color: "#00a6a6", mark: "位", items: ["工位身份回执", "扫码开工", "工艺指导", "投料确认", "过程记录", "工序报工", "交接班"] },
  ...
  { id: "reports", title: "报表与看板", layer: "经营分析", color: "#8e8e93", mark: "表", items: ["生产日报", "良率分析", "交付达成", "设备效率", "停机损失", "物料损耗", "MES 生产指标驾驶舱"] },
  { id: "basic", title: "基础资料", layer: "资料维护", color: "#007aff", mark: "基", items: ["产品资料", "物料资料", "BOM 清单", "工艺路线", "工序工位", "产线车间", "规则与代码", "班次日历", "客户供应商"] },
  { id: "system", title: "系统设置", layer: "管理配置", color: "#6e6e73", mark: "系", items: ["人员账号", "人员资质", "角色权限", "审批设置", "接口补偿配置", "消息提醒", "操作记录", "数据归档与恢复演练"] },
];
...
const MES_NAV_BASE = (() => {
  ...
  if (scriptSrc.startsWith("../") || scriptSrc.includes("/../")) return "../";
  return "./";
})();
...
const MES_NAV_ROUTES = {
  ...
  dispatch: {
    ...
    "工艺文件与作业指导": "dispatch/sop-view.html",
    "SOP 查看": "dispatch/sop-view.html",
    开工检查: "dispatch/start-check.html",
  },
  station: {
    "工位身份回执": "station/employee-login.html",
  ...
  reports: {
    ...
    "MES 生产指标驾驶舱": "reports/management-cockpit.html",
  ...
  system: {
    ...
    数据归档与恢复演练: "settings/data-backup.html",
