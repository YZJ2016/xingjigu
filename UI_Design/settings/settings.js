...
const pageDefinitions = {
  ...
  sync: {
    subtitle: "接口管理员维护 ERP、PLM、WMS、QMS、BI 接口补偿、重试、审批和对账规则；业务单据执行状态仍在对应业务页面查看",
    user: "接口管理员",
    metricLabels: ["接口目录", "今日成功", "待补偿", "对账差异"],
    columns: ["接口 / 单据", "来源到目标", "触发业务", "幂等与重试", "状态", "最近消息", "责任人", "时间戳"],
    tableTitle: "接口补偿配置与对账规则",
    tableHint: "系统设置只维护接口补偿、重试、审批和对账规则，不展示单张业务单据执行状态，不直接修改外部系统账务事实",
    cardTitle: "接口补偿治理闭环",
